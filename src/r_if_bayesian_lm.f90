subroutine hmc_fit_bayesian_lm(nr, nc, X, y, N, theta_sample, np, theta_init, nhp, hp, &
...
subroutine optim_bayesian_lm(nr, nc, X, y, np, p, nhp, hp, f, h, info)
	use bayesian_lm
	implicit none
...
subroutine log_ml_bayesian_lm(nr, nc, X, y, np, p, nhp, hp, r, info)
	use bayesian_lm
	implicit none
	integer, intent(in) :: nr, nc, np, nhp
	double precision, dimension(nr), intent(in) :: y
...
subroutine bayes_factor_lm(nr, nc, X, y, ns, np, sample, nhp, hp, ncnst, pcnst, cnst, r)
	use bayesian_lm
	implicit none
...
subroutine hmc_predict_lm(nr, nc, X, ss, np, P, y)
	use bayesian_lm
	implicit none
